...
-- Truth or Dare - SPICY TRUTHS (18+ content - opt-in only)
...
('truth_or_dare', 'truth', 'Bạn có từng fake orgasm không?', '18+'),
('truth_or_dare', 'truth', 'Người trong nhóm này bạn muốn "thử" nhất là ai?', '18+'),
('truth_or_dare', 'truth', 'Bạn đã từng sexting với ai chưa? Kể chi tiết', '18+'),
('truth_or_dare', 'truth', 'Điều kinky nhất bạn từng làm là gì?', '18+'),
('truth_or_dare', 'truth', 'Bạn có từng chụp/quay video 18+ không?', '18+'),
('truth_or_dare', 'truth', 'Lần đầu tiên của bạn như thế nào? Kể đi', '18+'),
('truth_or_dare', 'truth', 'Bạn có fetish gì đặc biệt không?', '18+'),
('truth_or_dare', 'truth', 'Ai là người bạn nghĩ đến khi "tự sướng"?', '18+'),
('truth_or_dare', 'truth', 'Bạn đã từng làm chuyện ấy ở đâu kỳ lạ nhất?', '18+'),
('truth_or_dare', 'truth', 'Số người bạn đã ngủ cùng là bao nhiêu? Thành thật đi', '18+'),
('truth_or_dare', 'truth', 'Bạn có từng threesome hoặc muốn thử không?', '18+'),
('truth_or_dare', 'truth', 'Điều gì bạn muốn thử trong phòng ngủ nhưng chưa dám nói?', '18+'),
...
('truth_or_dare', 'truth', 'Bạn có từng mơ thấy ai trong nhóm này trong giấc mơ 18+ không?', '18+'),
...
('truth_or_dare', 'dare', 'Mô tả chi tiết cảm giác khi bạn "đến đỉnh"', '18+'),
('truth_or_dare', 'dare', 'Làm tiếng rên giả trong 30 giây', '18+'),
('truth_or_dare', 'dare', 'Gửi tin nhắn "Em đang nghĩ về anh" cho người cuối cùng trong danh bạ', 'hard'),
('truth_or_dare', 'dare', 'Cắn môi người bên trái nhẹ nhàng', '18+'),
('truth_or_dare', 'dare', 'Để ai đó trong nhóm slap mông bạn', 'hard'),
('truth_or_dare', 'dare', 'Làm lap dance cho người được nhóm chọn', '18+'),
('truth_or_dare', 'dare', 'Hôn cổ người bên phải', '18+'),
('truth_or_dare', 'dare', 'Strip poker với người đối diện - thua cởi 1 món', '18+'),
...
('never_have_i_ever', 'question', 'Tôi chưa bao giờ bị bắt gặp đang "tự sướng"', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ làm trong toilet công cộng', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ gửi nudes cho người yêu', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ role-play trong phòng ngủ', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ dùng đồ chơi người lớn', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ làm với người hơn 10 tuổi', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ bị caught đang xem phim 18+', 'hard'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ có friends with benefits', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ làm vì tiền hoặc quà', '18+'),
('never_have_i_ever', 'question', 'Tôi chưa bao giờ quay video lúc làm', '18+'),
...
('challenge', 'action', 'Body shot từ rốn người được chọn', '18+'),
('challenge', 'action', 'Để nhóm chọn outfit cho bạn từ đồ có sẵn', 'hard'),
('challenge', 'action', 'Uống mà không nuốt trong 1 phút', 'hard'),
('challenge', 'action', 'Kiss or Slap - chọn 1 người và họ chọn kiss hay slap', '18+'),
